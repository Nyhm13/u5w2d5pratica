package it.epicode.u5w2d5pratica.controller;

import it.epicode.u5w2d5pratica.dto.PrenotazioneDto;
import it.epicode.u5w2d5pratica.dto.ViaggioDto;
import it.epicode.u5w2d5pratica.exception.ConflictException;
import it.epicode.u5w2d5pratica.exception.NotFoundException;
import it.epicode.u5w2d5pratica.exception.ValidationException;
import it.epicode.u5w2d5pratica.model.Prenotazione;
import it.epicode.u5w2d5pratica.model.Viaggio;
import it.epicode.u5w2d5pratica.service.PrenotazioneService;
